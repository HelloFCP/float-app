    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <p>Welcome to Float Global LLC ("Company", "we", "our", "us"). We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>
          ...
          <p>Float Global LLC<br />
          Email: privacy@float.com<br />
          Phone: +1 (800) 123-4567<br />
          Address: 123 Aviation Lane, City, State, ZIP</p>
        </div>
      </div>
    </div>
  )
